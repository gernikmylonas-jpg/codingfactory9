...
public class Account {
    ...
    public void withdraw(double amount, String ssn) throws Exception {
        try {
            if (amount < 0) throw new Exception("The amount= " + amount + " must be positive.");
            if (amount > balance) throw new Exception("The balance=" + balance +" is insufficient.");
            if (!isSsnValid(ssn)) throw new Exception("The SSN=" + ssn +" does not match.");
            balance -= amount;
        } catch (Exception e) {
     ...
     *
     * @return the string representation of the {@link gr.aueb.cf.cf9.ch12.Account} object.
     */
